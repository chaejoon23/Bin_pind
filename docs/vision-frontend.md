...
- **유튜브 영상 검증 미완.** 매니페스트(후보 3편: 야간 걷기 / 편집 브이로그 / 주간 대조군),
  다운로드·콘택트 시트·정답 초안 도구, 한글 판정은 준비됐다. 남은 것은 영상을 받아 정답을 채우고
  (결과를 보기 전에 커밋) 실행하는 것이다. 개발 샌드박스에서는 youtube.com 이 차단되어 받지 못했다.
